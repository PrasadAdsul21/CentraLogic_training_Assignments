...
namespace TaskWebAPI.Controllers
{
    ...
    public class TaskController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddTask(TaskModel taskModel)
        {
            ...
            taskDetails.CreatedByName = "Prasad";
            taskDetails.CreatedBy = "Prasad's UID";

            taskDetails.UpdatedOn = DateTime.Now;
            taskDetails.UpdatedByName = "Prasad";
            taskDetails.UpdatedBy = "Prasad's Uid";
        ...
        public async Task<IActionResult> UpdateTask(TaskDetails taskDetails)
        {
            ...
            existingtask.UpdatedByName = "Prasad";
            existingtask.UpdatedBy = "prasad's UId";
